...
* [X] List anything else that you can get done to improve the app functionality!
  - Replaced all action bars with toolbars for easier future custumization
  - Stylized tweets, media, and profile photos using the Card View Material Design Component
  - Added a cancel button for the tweet to easily return to the Timeline Activity
